        ...
        <div className='h-screen flex justify-between px-[115px] py-4 items-center pt-20'>
            <div>
                ...
                <div className='flex gap-4'>
                    <button className='bg-[#FF4C31] cursor-pointer text-white px-8 py-4 font-bold shadow-2xl shadow-[#FF4C31] hover:bg-gradient-to-r from-[#FF4C31] via-[#FF4C31] to-orange-400 rounded-sm'>Book Ride &nbsp; &nbsp;<FontAwesomeIcon icon={faCircleCheck} /></button>
